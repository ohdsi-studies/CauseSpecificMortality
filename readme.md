...
Vignette: [Using the package skeleton for patient-level prediction studies](https://raw.githubusercontent.com/OHDSI/StudyProtocolSandbox/master/mortality/inst/doc/UsingSkeletonPackage.pdf)

Instructions To Prepare Package Outside Atlas
===================

- Step 1: Change package name, readme and description (replace (mortality with the package name)
...
- Share the package by adding it to the OHDSI/StudyProtocolSandbox github repo and get people to install by running but replace 'mortality' with your study name if not using atlas:
```r
  ...
  devtools::install_github("OHDSI/StudyProtocolSandbox/mortality")
```

- Get users to execute the study by running the code in (extras/CodeToRun.R) but replace 'mortality' with your study name:
```r
  library(mortality)
  # USER INPUTS
#=======================
# The folder where the study intermediate and result files will be written:
outputFolder <- "./mortalityResults"
