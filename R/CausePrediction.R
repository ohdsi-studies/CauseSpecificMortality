...
causePrediction <- function (outputFolder, TAR = 30, algorithm = "rf", seedNum = NULL) {
  ...
  ### 4. Find the cause of death label
  labelStart <- 4
  labelEnd <- 2+length/2
  ...
  ### 5. Develop stacking ensemble model 
